...
// Register is a paid mutator transaction binding the contract method 0xf625b2a4.
//
// Solidity: function register(bytes32 userInternalPublicKeyX_, bytes32 userInternalPublicKeyY_, bytes s_, bytes n_, (uint256[2],uint256[2][2],uint256[2]) zkPoints_, uint256 proofTimestamp_, uint256 group1Hash_) returns()
func (_Registration *RegistrationTransactor) Register(opts *bind.TransactOpts, userInternalPublicKeyX_ [32]byte, userInternalPublicKeyY_ [32]byte, s_ []byte, n_ []byte, zkPoints_ VerifierHelperProofPoints, proofTimestamp_ *big.Int, group1Hash_ *big.Int) (*types.Transaction, error) {
	return _Registration.contract.Transact(opts, "register", userInternalPublicKeyX_, userInternalPublicKeyY_, s_, n_, zkPoints_, proofTimestamp_, group1Hash_)
}

// Register is a paid mutator transaction binding the contract method 0xf625b2a4.
//
// Solidity: function register(bytes32 userInternalPublicKeyX_, bytes32 userInternalPublicKeyY_, bytes s_, bytes n_, (uint256[2],uint256[2][2],uint256[2]) zkPoints_, uint256 proofTimestamp_, uint256 group1Hash_) returns()
func (_Registration *RegistrationSession) Register(userInternalPublicKeyX_ [32]byte, userInternalPublicKeyY_ [32]byte, s_ []byte, n_ []byte, zkPoints_ VerifierHelperProofPoints, proofTimestamp_ *big.Int, group1Hash_ *big.Int) (*types.Transaction, error) {
	return _Registration.Contract.Register(&_Registration.TransactOpts, userInternalPublicKeyX_, userInternalPublicKeyY_, s_, n_, zkPoints_, proofTimestamp_, group1Hash_)
}

// Register is a paid mutator transaction binding the contract method 0xf625b2a4.
//
// Solidity: function register(bytes32 userInternalPublicKeyX_, bytes32 userInternalPublicKeyY_, bytes s_, bytes n_, (uint256[2],uint256[2][2],uint256[2]) zkPoints_, uint256 proofTimestamp_, uint256 group1Hash_) returns()
func (_Registration *RegistrationTransactorSession) Register(userInternalPublicKeyX_ [32]byte, userInternalPublicKeyY_ [32]byte, s_ []byte, n_ []byte, zkPoints_ VerifierHelperProofPoints, proofTimestamp_ *big.Int, group1Hash_ *big.Int) (*types.Transaction, error) {
	return _Registration.Contract.Register(&_Registration.TransactOpts, userInternalPublicKeyX_, userInternalPublicKeyY_, s_, n_, zkPoints_, proofTimestamp_, group1Hash_)
}
